...
namespace Streamiz.Kafka.Net.Stream
{
    ...
    /// <see cref="IAggregator{K,V,VA}" /> can be used to implement aggregation functions like count.
    /// </summary>
    /// <typeparam name="K">key type</typeparam>
    /// <typeparam name="V">input value type</typeparam>
    /// <typeparam name="VA">aggregate value type</typeparam>
    public interface IAggregator<in K, in V, VA>
    {
        /// <summary>
    ...
    internal class WrappedAggregator<K, V, VA> : IAggregator<K, V, VA>
    {
